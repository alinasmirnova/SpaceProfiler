...
В первую очередь:
1. Отображать лоадер
2. Отображать недоступные папки и файлы
3. Сортировка узлов по размеру
4. Сделать бенчмарк на загрузку большой папки с диска
5. Принять решение, нужно ли параллелить загрузку дерева с диска и сколько потоков лучше брать
6. Прокачать Readme
