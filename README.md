...
<p align="center">
<img src="img_10.png" width="800" alt="your-image-description" style="border: 1px solid  gray;">
</p>
Если название элемента превышает 50 символов, то оно будет обрезано и в конце добавится "...". Для таких элементов при наведении на них появляется tooltip с полным именем
